        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Search results for: <br><?= Html::encode($search); ?></h2>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="<?= Url::to(['product/view', 'id' => $product->id]) ?>"><?= Html::img($product->getImage(), ['alt' => $product->name]) ?></a>
                                            <h2>$<?= $product->price ?></h2>
                    ...
                    <?php else : ?>
                        <h2>There are not results for your search request...</h2>
                    <?php endif; ?>
                </div><!--features_items-->
            </div>
        </div>
